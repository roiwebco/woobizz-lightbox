...
if (!function_exists( 'woobizz_show_sidebar_plugin_title' ) ) {
	function woobizz_show_lightbox_plugin_title() {
		if (strpos($_SERVER['REQUEST_URI'], "page=woobizz-lightbox") !== false){
	...
	add_action ('in_admin_header','woobizz_show_lightbox_plugin_title');
}